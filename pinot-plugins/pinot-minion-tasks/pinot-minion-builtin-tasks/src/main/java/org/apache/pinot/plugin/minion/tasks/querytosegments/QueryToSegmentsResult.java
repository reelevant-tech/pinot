...
/**
 * The class <code>QueryToSegmentsResult</code> wraps the segment generation and push
 * results.
 */
public class QueryToSegmentsResult {
  private final boolean _succeed;
  private final String _segmentName;
  private final Exception _exception;
  private final Map<String, Object> _customProperties;

  private QueryToSegmentsResult(boolean succeed, String segmentName, Exception exception,
  ...
  public static class Builder {
    ...
    public QueryToSegmentsResult build() {
      return new QueryToSegmentsResult(_succeed, _segmentName, _exception, _customProperties);
    }
  }
}
